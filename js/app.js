...
/* harmony import */ var _plugins_simplebar_init__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../plugins/_simplebar-init */ "./resources/js/plugins/_simplebar-init.js");
/* harmony import */ var _ui_tabs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./ui/_tabs */ "./resources/js/components/ui/_tabs.js");
/* harmony import */ var _ui_request_on_click__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./ui/_request-on-click */ "./resources/js/components/ui/_request-on-click.js");
/* harmony import */ var _utils_renderContainer__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./utils/_renderContainer */ "./resources/js/components/utils/_renderContainer.js");
...
var Application = /*#__PURE__*/function () {
  ...
  return _createClass(Application, [{
    ...
    value: function linkListener() {
      ...
      (0,_ui_request_on_click__WEBPACK_IMPORTED_MODULE_11__.sendRequestClickListener)();
      (0,_ui_tabs__WEBPACK_IMPORTED_MODULE_10__.tabs)();
      ...
      $(document).on('click', '.pagination-js a', function (e) {
        e.preventDefault();
        var $t = $(this);
        var $wrapper = $t.closest('.pagination-js');
        var href = $t.attr('href');
        var isLoadMore = $t.hasClass('load-more-js');
        if (href === undefined || href === '') return;
        (0,_utils_renderContainer__WEBPACK_IMPORTED_MODULE_12__["default"])(href, {
          $wrapper: $wrapper,
...
/***/ "./resources/js/components/utils/_renderContainer.js":
/*!***********************************************************!*\
  !*** ./resources/js/components/utils/_renderContainer.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ renderContainer)
/* harmony export */ });
...
function renderContainer(url) {
  ...
  var href = url;
  var $container = args['$container'] || $(document).find('.container-js');
  var $wrapper = args['$wrapper'] || $(document).find('.pagination');
  var isLoadMore = args['isLoadMore'] || false;
  var pushState = args['pushState'] || true;
...
function change_sbi_images_html() {
  $(document).find('.instagram-posts').each(function (index) {
    ...
    $items.each(function (i) {
      ...
      var imageElement = $item[0];
      var ID = "instagram-post__image-".concat(index, "-").concat(i);
      var temp = "\n             <div>\n                        <div class=\"instagram-post\" >\n                            <a href=\"".concat(href, "\" id=\"").concat(ID, "\" class=\"instagram-post__image\" style=\"display:block;\">\n                                <img src=\"").concat(src, "\" class=\"cover\" alt=\"\">\n                            </a>\n                        </div>\n                    </div>\n            ");
      html = html + temp;
    });
    if (html) {
...
function getImageSize(src) {
  return new Promise(function (resolve, reject) {
    ...
    img.onerror = function (error) {
      ...
      reject("\u041F\u043E\u043C\u0438\u043B\u043A\u0430 \u0437\u0430\u0432\u0430\u043D\u0442\u0430\u0436\u0435\u043D\u043D\u044F \u0437\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u043D\u044F: ".concat(src));
    };
    img.src = src;
  });
}
function setAspectRatioPadding($el, imageWidth, imageHeight) {
  ...
  var container = $el[0];
  var paddingPercentage = imageHeight / imageWidth * 100;
  container.style.paddingBottom = "".concat(paddingPercentage, "%");
  console.log("\u0414\u043B\u044F \u043A\u043E\u043D\u0442\u0435\u0439\u043D\u0435\u0440\u0430 \u0432\u0441\u0442\u0430\u043D\u043E\u0432\u043B\u0435\u043D\u043E padding-bottom: ".concat(paddingPercentage, "%"));
}
...
/***/ "./resources/js/plugins/_simplebar-init.js":
/*!*************************************************!*\
  !*** ./resources/js/plugins/_simplebar-init.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
$(document).ready(function () {
  var $lists = $(document).find('.product-details-list');
  ...
  function initOrRecalculateScrollbars() {
    $('.product-details-list').each(function (index) {
      ...
      var $text = $el.closest('.product-details').find('.product-details__text');
      if ($text.length > 0) {
        var textH = $text.outerHeight();
        $el.css('max-height', "calc(100% - ".concat(textH, "px)"));
      } else {
        $el.css('max-height', '100%');
      }
      var newInstance = new simplebar__WEBPACK_IMPORTED_MODULE_0__["default"]($el[0]);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkquadsystems"] = self["webpackChunkquadsystems"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["css/app","css/forms","css/fix"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/app","css/forms","css/fix"], () => (__webpack_require__("./resources/sass/app.scss")))
/******/ 	__webpack_require__.O(undefined, ["css/app","css/forms","css/fix"], () => (__webpack_require__("./resources/sass/fix.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app","css/forms","css/fix"], () => (__webpack_require__("./resources/sass/forms.scss")))
